...
ad_prices_price_level.csv: make_ad_prices_price_level.py make_ad_zero_prices.py make_ad_price_ad_level.py make_ad_price_ad_level_all.py data/forGiantOak3/msa_locations.tsv data/forGiantOak3/doc-provider-timestamp.tsv data/forGiantOak3/isssexad.tsv data/forGiantOak3/ismassageparlorad.tsv data/forGiantOak6/incall-new.tsv
	python make_ad_prices_price_level.py
	python make_ad_zero_prices.py
	python make_ad_price_ad_level.py
	python make_ad_price_ad_level_all.py
